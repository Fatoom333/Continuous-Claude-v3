...
See [/premortem skill]($CLAUDE_CC_DIR/.claude/skills/premortem/SKILL.md) for details.
...
**How it works:** Call graphs navigate to relevant code, then structured summaries replace reading entire files. Available via `tldr` CLI (see [TLDR documentation]($CLAUDE_CC_DIR/docs/tools/tldr.md)).
...
- See [TLDR documentation]($CLAUDE_CC_DIR/docs/tools/tldr.md)

## Related Documentation

- [Agents]($CLAUDE_CC_DIR/docs/agents/README.md) - Individual agent documentation
- [Hooks]($CLAUDE_CC_DIR/docs/hooks/README.md) - Lifecycle extensions
- [Skills]($CLAUDE_CC_DIR/docs/skills/help.md) - Skill system overview
- [TLDR-code]($CLAUDE_CC_DIR/docs/tools/tldr.md) - Token-efficient code analysis
- [Pre-mortem]($CLAUDE_CC_DIR/.claude/skills/premortem/SKILL.md) - Risk analysis technique
...
For questions or issues, see the main [README]($CLAUDE_CC_DIR/README.md).
